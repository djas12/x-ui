...
func (s *Server) startTask() {
	...
	// Periksa apakah xray berjalan setiap 30 detik
	s.cron.AddJob("@every 30s", job.NewCheckXrayRunningJob())

	go func() {
		time.Sleep(time.Second * 5)
		// Lalu lintas dihitung setiap 10 detik, dan startup pertama tertunda 5 detik, yang terhuyung-huyung dengan waktu memulai ulang xray
		s.cron.AddJob("@every 10s", job.NewXrayTrafficJob())
	}()

	// Periksa lalu lintas masuk yang melebihi dan kedaluwarsa setiap 30 detik
